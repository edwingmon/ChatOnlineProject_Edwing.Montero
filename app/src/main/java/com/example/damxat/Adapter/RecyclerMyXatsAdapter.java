...
public class RecyclerMyXatsAdapter extends RecyclerView.Adapter<RecyclerMyXatsAdapter.ViewHolder> {
    private ArrayList<User> arrayList;
    private Context context;

    public RecyclerMyXatsAdapter(ArrayList<User> arrN, Context c){
        this.arrayList = arrN;
        this.context = c;
    }
