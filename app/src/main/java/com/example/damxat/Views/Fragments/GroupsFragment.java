...
public class GroupsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /* Recargamos los grupos que hay en la base de datos
          y se los aplicamos al recyler */
        refreshRecycler();

        //Boton para agregar un nuevo grupo a la base de datos
        FloatingActionButton btnAddGroup = groupView.findViewById(R.id.floatingActionButton);
        btnAddGroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Llamamos al método para mostrar el cuadro de conf. de agregar grupos
                showDialog();

                //Llamamos al método para recargar el recycler de los grupos
                refreshRecycler();
            }
        });
    ...
    //Mostrar el cuadro de configuración para crear un grupo
    public void showDialog(){
        ...
        //Boton para confirmar el guardado del grupo
        btnSaveList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Obtenemos la referencia de nuestra base de datos(firebase)
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference();

                //Declaramos un grupo paandole el nombre especificado en la conf.
                XatGroup group = new XatGroup(groupNameTxt);

                //Le asignamos el grupo a la referencia de nuestro FireBase(ahora si, agregamos el grupo al firebase)
                ref.child("Groups").child(groupNameTxt).setValue(group);

                //Sacamos el cuadro de conf.
                dialog.dismiss();
            }
        });
    }
    ...
    public void refreshRecycler(){
        ...
        //Recargamos los grupos de la base de datos
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                arrayGroups.clear();
                //Vamos agregando los grupos de 1 en 1 desde la base de datos
